<?php
/**
 * SEED DATA ONLY — as of v1.1.0 you do NOT edit this file to add a school.
 *
 * Schools are managed in the WordPress admin under WooCommerce > School Order
 * Forms, and live in the database from then on. The array below is copied into
 * the database once, the first time v1.1.0 runs, so the existing Redondo page
 * carries over untouched. After that, editing this file has no effect.
 *
 * It is kept as a safety net: if the stored settings ever went missing, the
 * order pages fall back to this instead of breaking.
 */
